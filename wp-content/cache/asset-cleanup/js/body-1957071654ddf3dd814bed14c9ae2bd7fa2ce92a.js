...
/*!/wp-content/cache/asset-cleanup/js/item/content__uploads__bb-plugin__cache__9868-layout-js-v8a673404be025424acd3fcc655d2338de5859564.js*/
/*!/wp-content/uploads/bb-plugin/cache/9868-layout.js*/
var wpAjaxUrl =
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5eda6ce9d9002 .fl-photo-img")
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5eda6ce9d9009 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5eda6ce9d9010 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5eda6ce9d9017 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5ee7bbb1981e2 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5ee7be019bb79 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5ee7c11312629 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-8h6obx2qktgr .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
(function ($) {
  $(function () {
    var sliderIndex =
      ...
      dots = 1;
    if (!1 === sliderIndex) {
      $(".fl-node-u94kt0mpwbqi .fl-content-slider-wrapper").css("opacity", "1");
    }
    var slider = $(".fl-node-u94kt0mpwbqi .fl-content-slider-wrapper")
      .delay(1000)
      .bxSlider({
        adaptiveHeight: !0,
        ariaLive: !1,
        ...
        onSliderLoad: function (currentIndex) {
          if (!1 !== sliderIndex) {
            $(".fl-node-u94kt0mpwbqi .fl-content-slider-wrapper").css(
              "opacity",
              "1",
            );
          }
          $(".fl-node-u94kt0mpwbqi .fl-content-slider-wrapper").addClass(
            "fl-content-slider-loaded",
          );
          $(".fl-node-u94kt0mpwbqi iframe").each(function () {
        ...
        onSlideBefore: function (ele, oldIndex, newIndex) {
          this.stopAuto(!0);
          $(".fl-node-u94kt0mpwbqi .fl-content-slider-navigation a").addClass(
            "disabled",
          );
          $(".fl-node-u94kt0mpwbqi .bx-controls .bx-pager-link").addClass(
            "disabled",
          );
          this.startAuto(!0);
        },
        onSlideAfter: function (ele, oldIndex, newIndex) {
          var prevSlide = $(
              ".fl-node-u94kt0mpwbqi .fl-slide-" + oldIndex + ":not(.bx-clone)",
            ),
            newSlide = $(
              ".fl-node-u94kt0mpwbqi .fl-slide-" + newIndex + ":not(.bx-clone)",
            );
          ...
          $(
            ".fl-node-u94kt0mpwbqi .fl-content-slider-navigation a",
          ).removeClass("disabled");
          $(".fl-node-u94kt0mpwbqi .bx-controls .bx-pager-link").removeClass(
            "disabled",
          );
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5eda6ce9d9026 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {

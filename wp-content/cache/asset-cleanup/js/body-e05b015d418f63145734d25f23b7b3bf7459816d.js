...
/*!/wp-content/cache/asset-cleanup/js/item/content__uploads__bb-plugin__cache__1097-layout-js-v271ca8944f26890f16fdf92ac735964fec40d164.js*/
/*!/wp-content/uploads/bb-plugin/cache/1097-layout.js*/
var wpAjaxUrl =
...
(function ($) {
  ...
  $(window).on("load", function () {
    if (!is_touch_device()) {
      $(".fl-node-v6y7qu48ztlw .pp-flipbox-container").on(
        "mouseenter",
        function (e) {
          e.preventDefault();
    ...
    $(".fl-node-v6y7qu48ztlw .pp-flipbox-container").on("click", function (e) {
      $(this).toggleClass("pp-hover");
    });
    var updateHeight = function () {
      if (
        $(".fl-node-v6y7qu48ztlw .pp-flipbox-front").outerHeight() >
        $(".fl-node-v6y7qu48ztlw .pp-flipbox-back").outerHeight()
      ) {
        $(".fl-node-v6y7qu48ztlw .pp-flipbox-back").css(
          "height",
          $(".fl-node-v6y7qu48ztlw .pp-flipbox-front").outerHeight() + "px",
        );
      } else {
        $(".fl-node-v6y7qu48ztlw .pp-flipbox-front").css(
          "height",
          $(".fl-node-v6y7qu48ztlw .pp-flipbox-back").outerHeight() + "px",
        );
      }
    };
    updateHeight();
    ...
    $(document).on("pp_expandable_row_toggle", function (e, selector) {
      if (
        ...
        selector.parent().find(".fl-node-v6y7qu48ztlw").length > 0 &&
        !heightSet
      ) {
        updateHeight();
        heightSet = !0;
...
(function ($) {
  ...
  $(window).on("load", function () {
    if (!is_touch_device()) {
      $(".fl-node-1dyavfrlhbwj .pp-flipbox-container").on(
        "mouseenter",
        function (e) {
          e.preventDefault();
          $(this).addClass("pp-hover");
    ...
    $(".fl-node-1dyavfrlhbwj .pp-flipbox-container").on("click", function (e) {
      $(this).toggleClass("pp-hover");
    });
    var updateHeight = function () {
      if (
        $(".fl-node-1dyavfrlhbwj .pp-flipbox-front").outerHeight() >
        $(".fl-node-1dyavfrlhbwj .pp-flipbox-back").outerHeight()
      ) {
        $(".fl-node-1dyavfrlhbwj .pp-flipbox-back").css(
          "height",
          $(".fl-node-1dyavfrlhbwj .pp-flipbox-front").outerHeight() + "px",
        );
      } else {
        $(".fl-node-1dyavfrlhbwj .pp-flipbox-front").css(
          "height",
          $(".fl-node-1dyavfrlhbwj .pp-flipbox-back").outerHeight() + "px",
        );
      }
    };
    updateHeight();
    ...
    $(document).on("pp_expandable_row_toggle", function (e, selector) {
      if (
        selector.is(".pp-er-open") &&
        selector.parent().find(".fl-node-1dyavfrlhbwj").length > 0 &&
        !heightSet
      ) {
        updateHeight();
        heightSet = !0;
...
(function ($) {
  ...
  $(window).on("load", function () {
    if (!is_touch_device()) {
      $(".fl-node-e5qayrw2ukt7 .pp-flipbox-container").on(
        "mouseenter",
        function (e) {
          e.preventDefault();
          $(this).addClass("pp-hover");
    ...
    $(".fl-node-e5qayrw2ukt7 .pp-flipbox-container").on("click", function (e) {
      $(this).toggleClass("pp-hover");
    });
    var updateHeight = function () {
      if (
        $(".fl-node-e5qayrw2ukt7 .pp-flipbox-front").outerHeight() >
        $(".fl-node-e5qayrw2ukt7 .pp-flipbox-back").outerHeight()
      ) {
        $(".fl-node-e5qayrw2ukt7 .pp-flipbox-back").css(
          "height",
          $(".fl-node-e5qayrw2ukt7 .pp-flipbox-front").outerHeight() + "px",
        );
      } else {
        $(".fl-node-e5qayrw2ukt7 .pp-flipbox-front").css(
          "height",
          $(".fl-node-e5qayrw2ukt7 .pp-flipbox-back").outerHeight() + "px",
        );
      }
    };
    updateHeight();
    ...
    $(document).on("pp_expandable_row_toggle", function (e, selector) {
      if (
        selector.is(".pp-er-open") &&
        selector.parent().find(".fl-node-e5qayrw2ukt7").length > 0 &&
        !heightSet
      ) {
        updateHeight();
        heightSet = !0;
...
(function ($) {
  ...
  $(window).on("load", function () {
    if (!is_touch_device()) {
      $(".fl-node-iajm5vxsu71d .pp-flipbox-container").on(
        "mouseenter",
        function (e) {
          e.preventDefault();
          $(this).addClass("pp-hover");
    ...
    $(".fl-node-iajm5vxsu71d .pp-flipbox-container").on("click", function (e) {
      $(this).toggleClass("pp-hover");
    });
    var updateHeight = function () {
      if (
        $(".fl-node-iajm5vxsu71d .pp-flipbox-front").outerHeight() >
        $(".fl-node-iajm5vxsu71d .pp-flipbox-back").outerHeight()
      ) {
        $(".fl-node-iajm5vxsu71d .pp-flipbox-back").css(
          "height",
          $(".fl-node-iajm5vxsu71d .pp-flipbox-front").outerHeight() + "px",
        );
      } else {
        $(".fl-node-iajm5vxsu71d .pp-flipbox-front").css(
          "height",
          $(".fl-node-iajm5vxsu71d .pp-flipbox-back").outerHeight() + "px",
        );
      }
    };
    updateHeight();
    ...
    $(document).on("pp_expandable_row_toggle", function (e, selector) {
      if (
        selector.is(".pp-er-open") &&
        selector.parent().find(".fl-node-iajm5vxsu71d").length > 0 &&
        !heightSet
      ) {
        updateHeight();
        heightSet = !0;

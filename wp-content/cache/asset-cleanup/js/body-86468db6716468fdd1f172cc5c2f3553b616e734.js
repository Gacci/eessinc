...
/*!/wp-content/cache/asset-cleanup/js/item/content__uploads__bb-plugin__cache__9451-layout-js-v50f1487a45d0f148a4658afddff9c0c2ea38b34c.js*/
/*!/wp-content/uploads/bb-plugin/cache/9451-layout.js*/
var wpAjaxUrl =
...
(function ($) {
  ...
  FLBuilderAccordion.prototype = {
    ...
    expandOnTab: !1,
    _init: function () {
      $(this.nodeClass + " .fl-accordion-button").on(
        "click",
        $.proxy(this._buttonClick, this),
      );
      $(this.nodeClass + " .fl-accordion-button").on(
        "keypress",
        $.proxy(this._buttonClick, this),
      );
      $(this.nodeClass + " .fl-accordion-button-label").on(
        "focusin",
        $.proxy(this._labelFocusIn, this),
      );
      $(this.nodeClass + " .fl-accordion-button").on(
        "focusout",
        $.proxy(this._focusOut, this),
      );
    ...
    _openActiveAccordion: function (e) {
      var activeAccordion = $(
        this.nodeClass + " .fl-accordion-item.fl-accordion-item-active",
      );
    ...
    _toggleAccordion: function (button) {
      var accordion = button.closest(".fl-accordion"),
        ...
        allIcons = accordion.find(
          ".fl-accordion-button i.fl-accordion-button-icon",
        ),
        content = button.siblings(".fl-accordion-content"),
        icon = button.find("i.fl-accordion-button-icon");
      if (accordion.hasClass("fl-accordion-collapse")) {
        accordion
          .find("> .fl-accordion-item-active")
          .removeClass("fl-accordion-item-active");
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5cba2f44b8a72 .fl-photo-img")
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-bj4ed8gwu3xf .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
